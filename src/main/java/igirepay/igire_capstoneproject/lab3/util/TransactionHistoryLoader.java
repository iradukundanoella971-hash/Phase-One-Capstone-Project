...
/**
 * Loads transaction history with database timestamps (Lab3 helper — reuses Lab2 connection).
 */
public final class TransactionHistoryLoader {
    ...
    public static List<Transaction> loadForAccount(String accountNumber) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            return fallback(accountNumber);
        }

        return result;
    }

    private static List<Transaction> fallback(String accountNumber) {
